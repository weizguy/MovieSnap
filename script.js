...
function searchItunes(search) {
    ...
    $.getJSON(url, function (data) {
        ...
        $('#artistName').text(data.results[0].collectionName);
            ...
            $('#music1').attr('src', data.results[0].previewUrl);
            $('#music2').attr('src', data.results[1].previewUrl);
            $('#music3').attr('src', data.results[2].previewUrl);
            $('#music4').attr('src', data.results[3].previewUrl);
            $('#music5').attr('src', data.results[4].previewUrl);
            $('#music6').attr('src', data.results[5].previewUrl);
            $('#music7').attr('src', data.results[6].previewUrl);
            $('#music8').attr('src', data.results[7].previewUrl);
            $('#music9').attr('src', data.results[8].previewUrl);
            $('#music10').attr('src', data.results[9].previewUrl);

            $('#track1').text(data.results[0].trackName);
            $('#track2').text(data.results[1].trackName);
            $('#track3').text(data.results[2].trackName);
            $('#track4').text(data.results[3].trackName);
            $('#track5').text(data.results[4].trackName);
            $('#track6').text(data.results[5].trackName);
            $('#track7').text(data.results[6].trackName);
            $('#track8').text(data.results[7].trackName);
            $('#track9').text(data.results[8].trackName);
            $('#track10').text(data.results[9].trackName);
